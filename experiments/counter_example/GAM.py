...
samples_GAM, avg_acc, accepted_GAM, samples_index_array_RBAM = \
    Global_AM(counter_posterior, prior, X_INIT,
              4000000, 1600000, [], acceptance)


np.save(f'{RESULTS_DIR}{os.sep}samples_GAM_counter_example.npy', samples_GAM)
np.save(f'{RESULTS_DIR}{os.sep}accepted_GAM_counter_example.npy', accepted_GAM)
np.save(f'{RESULTS_DIR}{os.sep}samples_index_array_GAM.npy', samples_index_array_RBAM)
