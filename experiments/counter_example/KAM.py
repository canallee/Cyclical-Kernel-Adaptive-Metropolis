...
# begin training
samples_KAM, avg_acc, history, samples_index_array_KAM, stepsize_array_KAM = KAM(counter_posterior, prior, X_INIT, iterations, burnin, [],
                                                                                 acceptance, initial_stepsize, gradk, idx_schedule, noise_schedule,
                                                                                 eps=2, optim_acc=0.234)

np.save(f'{RESULTS_DIR}{os.sep}samples_KAM_counter_example.npy', samples_KAM)
np.save(f'{RESULTS_DIR}{os.sep}samples_index_array_KAM.npy', samples_index_array_KAM)
np.save(f'{RESULTS_DIR}{os.sep}stepsize_array_KAM.npy', stepsize_array_KAM)
