...
samples_MH, avg_acc, accepted_MH, samples_index_array_MH = \
    Vanilla_MH(counter_posterior, prior, X_INIT,
               4000000, 1600000, [], acceptance)


np.save(f'{RESULTS_DIR}{os.sep}samples_MH_counter_example.npy', samples_MH)
np.save(f'{RESULTS_DIR}{os.sep}accepted_MH_counter_example.npy', accepted_MH)
np.save(f'{RESULTS_DIR}{os.sep}samples_index_array_MH.npy', samples_index_array_MH)
